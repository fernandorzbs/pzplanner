...
return [
    ...
    */
    ...
    | convención "attribute.rule" para nombrar las líneas. Esto permite especificar un
    | mensaje personalizado específico para una regla de atributo determinada.
    |
    */
    ...
    | de "email". Esto simplemente nos ayuda a hacer que el mensaje sea un poco más claro.
    |
    */
