    ...
    <div class="col-md-8 grid-margin stretch-card">
        <div class="card">
            <div class="card-header">
                <h6 class="fw-normal">Agregar un <strong>Contacto</strong></h6>
            </div>
            <div class="card-body">
                <form action="{{route('contacto.store')}}" id="formDropzone" method="POST" enctype="multipart/form-data" novalidate>
                    @csrf
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col">
                            <x-input-text title="Nombre" id="nombre" />
                            <x-input-text title="Apellido" id="apellido" />
