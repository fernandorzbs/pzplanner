...
<div class="row">
    <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('campana.store')}}" id="formDropzone" method="POST" enctype="multipart/form-data" novalidate>
                    @csrf
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col">
                            <x-input-text title="Nombre del evento" id="nombre" />
                            <div class="col">
                                <label for="fecha" class="form-label">Fecha del evento:</label>
                                <div class="input-group flatpickr" id="flatpickr-date">
                                    <input type="text" id="fecha" name="fecha" class="form-control" placeholder="Seleccionar fecha" data-input>
